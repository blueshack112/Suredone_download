...
def get_args():
    ...
    parser.add_argument(
        ...
        '--email',
        type=str,
        default='mahoney_patrick@hotmail.com',
        help='results emailed when processing is complete (default=mahoney_patrick@hotmail.com)')
    parser.add_argument(
        '-n',
        '--name_integration',
        type=str,
        default='mikesautoparts',
        help='name used from SureDone to identify your application to the API for logging (default=mikesautoparts)'
    )
